...
class Net_lstm(torch.nn.Module):
    ...
    def __init__(self, n, alpha=0.2, sigma_rec=0.15, input_size=4, output_size=2, dale=True,
                 activation=torch.nn.ReLU(), dropout=0.0, layer_norm=False):
        """
        Args:
            n (int): Number of neurons in the LSTM layer.
            alpha (float): Scaling factor for noise.
            sigma_rec (float): Standard deviation of recurrent noise.
            input_size (int): Size of the input layer.
            output_size (int): Size of the output layer.
            dale (bool): Whether to apply Dale's law.
